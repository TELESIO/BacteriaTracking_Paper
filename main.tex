...
\begin{abstract}
%\lipsum[1-1]
Particle tracking plays an important role in numerous fields of science; In this paper we present TraCCA, an algorithm for detecting and tracking particles based on geometrical difference evaluation and centroid displacement analysis to reconstruct the trajectories. 
...
Due to the large number of particles often involved in such applications, a preliminary parallel GPGPU + MPI version of the framework is currently being developed which has provided promising results in terms of scalability and speed up, allowing much larger dataset to be analyzed. Eventually, it is worth to note that under the assumption of associativity of the \textit{assignment operator} $\lozenge$, the tracking algorithm could be implemented using the \textit{parallel reduction} design pattern.
    \begin{figure}
      \begin{center}
        ...
        \caption{Final collective view of all the tracked bacteria tracjectories as obtained by processing all 4100 images of the case study dataset. For the sake of figure clarity, a random color is associated to each bacterium trajectory.}
      \end{center}
    \end{figure}
...
\begin{tabular}{cccc}
\subfloat{\includegraphics[width = 0.13\textwidth]{./images/1.png}} &
\subfloat{\includegraphics[width = 0.13\textwidth]{./images/2.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/3.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/4.png}}\\
\subfloat{\includegraphics[width = 0.13\textwidth]{./images/5.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/6.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/7.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/8.png}}\\
\subfloat{\includegraphics[width = 0.13\textwidth]{./images/9.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/10.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/11.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/12.png}}\\
\subfloat{\includegraphics[width = 0.13\textwidth]{./images/13.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/14.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/15.png}} &
\subfloat {\includegraphics[width = 0.13\textwidth]{./images/16.png}}\\
